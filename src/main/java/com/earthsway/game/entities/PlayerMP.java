...
public class PlayerMP extends Player {
    ...
    public PlayerMP(Level level, int x, int y, InputHandler input, int scale, String username, InetAddress ipAddress, int port) {
        super(level, x, y, input, scale, username);
    ...
    public PlayerMP(Level level, int x, int y, int scale, String username, InetAddress ipAddress, int port) {
        super(level, x, y, null, scale, username);
        this.ipAddress = ipAddress;
        this.port = port;
    }
